(() => {
        ...
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            R = function (e, t, s) {
              A(e, t.class_loading),
                S(e, f),
                s && (P(s, 1), k(t.callback_loading, e, s));
            },
            Y = function (e, t, s) {
  ...
  (() => {
    ...
    class p {
      ...
      maskActions(e) {
        ...
        if (t.closest("._mask-init")) {
          const s = t,
            i = (s.value, this.getMask(s));
          console.log(s.selectionStart),
            s.selectionStart > i.length && e.preventDefault();
        }
      }
      setLogging(e) {
    ...
    Object.keys(_).forEach((e) => {
      Object.defineProperty(S.fn, e, { value: _[e], writable: !0 });
    });
    const L = S;
    function k(e, t) {
      ...
      ve(),
        document.querySelector(".swiper") &&
          new ue(".swiper", {
            ...
            loop: !0,
            lazy: !0,
            pagination: { el: ".main-slider__bullets", clickable: !1 },
            navigation: {
    ...
    document.addEventListener("click", function (e) {
      ...
      i.length > 1 && ye(i, "_ok");
      !t.closest(".menu__item") && i.length > 0 && ye(i, "_ok");
      ...
      (u.inputMaskModule = new p({ logging: Ce })),
      new be({}),
      (function () {
        function e(e) {
          if ("click" === e.type) {
